...
def create_dataframe(): 
    dataset = pd.read_csv("/Users/naren/Flask_app/final_dataset.csv")
...
def Random_Forest_classifier(x_train, y_train):
    ...
    joblib.dump(clf, '/Users/naren/Flask_app/Malaria-Detection-master/randomforest.pkl')


def user_loaded_model():

    clf = joblib.load('/Users/naren/Flask_app/Malaria-Detection-master/randomforest.pkl')
